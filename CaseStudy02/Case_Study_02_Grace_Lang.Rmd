...
# Other Models for Final Rundown
...
par(mfrow=c(2,2))
plot(varImp(object=fit_svm),   main="SVM - Variable Importance")
...
salary_url <- "https://raw.githubusercontent.com/GraceLang1110/SMU_MSDS_Github/master/CaseStudy02/CaseStudy2CompSet%20No%20Salary.csv"
...
identical(levels(Test$MonthlyIncome),levels(PredictionsSal_rf))
